        ...
        <div class="card-body p-4">
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3 form-outline">
                        <input class="form-control" type="number" name="qty" placeholder=" " value="1" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3 form-outline">
                        <input class="form-control" type="number" name="discount" step="0.01" placeholder=" " value="0">
